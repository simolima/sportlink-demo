    ...
    return (
        <section className="py-16 bg-base-100">
            <div className="max-w-4xl mx-auto px-4">
                <h2 className="text-3xl font-bold text-base-content mb-2 text-center">Servizi Offerti</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {studio.servicesOffered.map((service, idx) => (
                        <div
                            key={idx}
                            className="flex items-start gap-3 p-4 rounded-lg hover:bg-base-200 transition-colors"
                        >
