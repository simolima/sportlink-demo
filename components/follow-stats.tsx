    ...
    return (
        <div className="relative inline-block">
            <button
                type="button"
                onClick={() => setOpen(o => !o)}
                className="px-3 py-1 rounded-full bg-gray-100 hover:bg-gray-200 text-xs font-medium transition"
                title="Statistiche follow"
            >{label}</button>
            {open && (
                <div className="absolute z-10 mt-2 w-56 p-3 rounded shadow bg-white border text-xs">
