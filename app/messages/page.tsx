    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={() => setShowNew(v => !v)} className="text-sm px-3 py-1.5 rounded bg-blue-600 text-white hover:bg-blue-700">
                    ...
                    <li key={c.peerId} className="p-4 hover:bg-gray-50 flex items-center justify-between">
                        <div className="min-w-0">
                            {(() => {
                                ...
                                return (
                                    <Link href={`/messages/${c.peerId}`} className="font-medium text-blue-600 hover:underline">{display}</Link>
                                )
                            })()}
                    ...
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
                        {users
                            ...
                            .map(u => {
                                ...
                                return (
                                    <Link key={u.id} href={`/messages/${u.id}`} className="border rounded p-3 text-sm hover:bg-blue-50">
