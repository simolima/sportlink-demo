    ...
    return (
        <>
            <button
                type="button"
                onClick={openModal}
                className="btn btn-sm gap-1.5 bg-primary text-white hover:bg-primary-hover border-0"
            >
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
                        ...
                        <div className="modal-action mt-2 pt-2 border-t border-base-200">
                            ...
                            <button
                                type="submit"
                                disabled={isPending}
                                className="btn bg-primary text-white hover:bg-primary-hover border-0 gap-1.5"
                            >
